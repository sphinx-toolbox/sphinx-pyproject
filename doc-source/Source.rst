...
The ``sphinx-pyproject`` source code is available on GitHub,
...
The recommended way to build ``sphinx-pyproject`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
